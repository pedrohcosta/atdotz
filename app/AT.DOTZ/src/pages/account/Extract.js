...
function Extract(props) {
    ...
    const [listExtract, setListExtract] = useState([]);
    ...
    async function load() {
        ...
        const objResult = await AccountController.getExtract(id);
        setPreLoad(false);
        if (objResult != null) {
            setListExtract(objResult)
        } else {
            Util.erro('Erro ao buscar extrato!');
        }
    }
                                        ...
                                        <View>
                                            <View style={{ flexDirection: "row" }}>
                                                <View style={{ flex: 0.5, flexDirection: "row", marginRight: 4 }}>
                                                    <View>
                                                        <Text style={{ fontSize: 15, fontWeight: 'bold' }}>Valor:</Text>
                                                    </View>
                                                ...
                                                <View style={{ flex: 0.5, flexDirection: "row" }}>
                                                    <View>
                                                        <Text style={{ fontSize: 15, fontWeight: 'bold' }}>Documento:</Text>
                                                    </View>
                                                    <View style={{ paddingLeft: 4, flexDirection: "row" }}>
                                                        <Text>{item.documentCode}</Text>
                                                    </View>
                                                </View>
                                            </View>
                                            <View style={{ flexDirection: "row" }}>
                                                <View style={{ flex: 0.5, flexDirection: "row", marginRight: 4 }}>
                                                    <View>
                                                        <Text style={{ fontSize: 15, fontWeight: 'bold' }}>Dotz:</Text>
                                                    </View>
                                                    <View style={{ paddingLeft: 4, flexDirection: "row" }}>
                                                        <Text>{item.dotz}</Text>
                                                    </View>
                                            ...
                                            <View style={{ flexDirection: "row" }}>
                                                <View style={{ flex: 0.5, flexDirection: "row", marginRight: 4 }}>
                                                    ...
                                                    <View style={{ paddingLeft: 4, flexDirection: "row" }}>
                                                        <Text>{item.type==1?'Deposito':'Pagamento'}</Text>
                                                    </View>
                                                </View>
                                            </View>
